...
const UserSidebar = ({ users, selectedUserId, onUserSelect, theme, collapsed, toggleCollapse, hideHeader }) => {
  ...
  return (
        ...
        `}
        >
      {/* Cabecera con color y botón toggle */}
      {!hideHeader && (
        <div
              ...
              {onlineUsers.length > 0 ? (
                onlineUsers.map((user) => (
                  <button
                    ...
                    className={`
                      w-full text-left py-2 px-3 rounded hover:bg-${theme === 'dark' ? 'gray-700' : 'gray-200'}
